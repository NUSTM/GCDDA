...
class BartEncoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        self.embed_tokens_l = nn.Embedding(6, embed_dim, 5)
    ...
    def forward(
        ...
        if inputs_embeds is None:
            inputs_embeds = self.embed_tokens(input_ids) * self.embed_scale+self.embed_tokens_l(en_labels)
...
class BartDecoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        self.embed_tokens_l = nn.Embedding(6, config.d_model, 5)
    ...
    def forward(
        ...
        if inputs_embeds is None:
            # print(input_ids.size(),de_labels_ids.size(),'333')
            inputs_embeds = self.embed_tokens(input_ids) * self.embed_scale+self.embed_tokens_l(de_labels_ids)
